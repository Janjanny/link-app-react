...
const CategoryModal = ({isActive, setActive, handleCategory}) => {
  return (
    <div className='fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50'>
        ...
        <input type="text" name="price" id="price" class="block rounded-md border-0 py-1.5 pl-3  ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 text-black w-[20rem]" placeholder="Enter Category Name"></input>
