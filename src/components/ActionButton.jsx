...
const ActionButton = ({isActive, setActive, openLinkModal, setOpenLinkModal, openCtgryModal, setOpenCtgryModal, handleAddBookmark, handleAddCategory}) => {
...
<div className='fixed bottom-[193px] right-20 flex justify-center items-center bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 text-sm font-medium py-2 px-4 gap-2 rounded-md cursor-pointer text-white' onClick={() => {setOpenCtgryModal(!openCtgryModal)}}>Remove Category <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
